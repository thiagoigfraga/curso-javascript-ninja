...
let qtd = pessoa.caminhouQuantosMetros += qtdMetros; 
let andando = pessoa.andando = true; 

return `Andando é ${andando}, ${qtd} metros percorridos`;
}
...
*/
pessoa.parar = function(){ pessoa.andando = false; return 'Parou'};
...
*/
//pessoa.nomeCompleto() // "Olá! Meu nome é Thiago Garcia!"
...
*/
//pessoa.caminhouQuantosMetros  //880
